...
public:
	...
	/// Updates an already laid-out single-line text run without dirtying document layout.
	/// Returns false when the current text/layout state is not safe for this fast path.
